 ...
 */
export const loadFromCache = async (binType: BinType): Promise<void> => {
		try {
			console.log(`📂 Loading data from cache for ${binType}...`)

			// Los datos ya están cargados en BinsService, solo loguear
 ...
 */
export const ensureDataAvailableAndGetContainers = async (
	binType: BinType,
