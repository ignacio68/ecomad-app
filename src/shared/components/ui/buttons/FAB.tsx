	...
	({
		...
		return (
			<Pressable
				...
				className={`ios:shadow-sm android:shadow-md android:shadow-black/80 h-14 w-14 flex-1 flex-row items-center justify-center rounded-xl border-[0.5px] border-gray-300 bg-surface`}
