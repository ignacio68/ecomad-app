...
export const DISTRICTS: District[] = [
	...
	},
	{
		...
		barrios: [
			{
				neighborhood_code: '071',
				num_bar: '1',
				nom_bar: 'GAZTAMBIDE',
				centroid: { lat: 40.4449, lng: -3.7138 },
			},
			{
				neighborhood_code: '072',
				num_bar: '2',
				nom_bar: 'ARAPILES',
				centroid: { lat: 40.4349, lng: -3.7038 },
			},
			{
				neighborhood_code: '073',
				num_bar: '3',
				nom_bar: 'TRAFALGAR',
				centroid: { lat: 40.4249, lng: -3.6938 },
			},
			{
				neighborhood_code: '074',
				num_bar: '4',
				nom_bar: 'ALMAGRO',
				centroid: { lat: 40.4149, lng: -3.6838 },
			},
			{
				neighborhood_code: '075',
				num_bar: '5',
				nom_bar: 'RIOS ROSAS',
				centroid: { lat: 40.4049, lng: -3.6738 },
			},
			{
				neighborhood_code: '076',
				num_bar: '6',
	...
	},
	{
		...
		barrios: [
			{
				neighborhood_code: '121',
				num_bar: '1',
				nom_bar: 'ORCASITAS',
				centroid: { lat: 40.3955, lng: -3.7156 },
			},
			{
				neighborhood_code: '122',
				num_bar: '2',
				nom_bar: 'ORCASUR',
				centroid: { lat: 40.3855, lng: -3.7056 },
			},
	...
	},
	{
		...
		barrios: [
			{
				neighborhood_code: '141',
				num_bar: '1',
				nom_bar: 'PAVONES',
				centroid: { lat: 40.4189, lng: -3.6494 },
			},
			{
				neighborhood_code: '142',
				num_bar: '2',
				nom_bar: 'HORCAJO',
				centroid: { lat: 40.4089, lng: -3.6394 },
			},
			{
				neighborhood_code: '143',
				num_bar: '3',
				nom_bar: 'MARROQUINA',
				centroid: { lat: 40.3989, lng: -3.6294 },
			},
			{
				neighborhood_code: '144',
				num_bar: '4',
				nom_bar: 'MEDIA LEGUA',
				centroid: { lat: 40.3889, lng: -3.6194 },
			},
			{
				neighborhood_code: '145',
				num_bar: '5',
				nom_bar: 'FONTARRON',
				centroid: { lat: 40.3789, lng: -3.6094 },
			},
			{
				neighborhood_code: '146',
				num_bar: '6',
				nom_bar: 'VINATEROS',
